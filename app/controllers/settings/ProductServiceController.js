...
const ProductService = require('../../models/settings/ProductService');
...
const permission_name = ['SETTING_PRODUCT_SERVICE'];

const IMAGES_DIR = './public/assets/images/settings_product_service';
const VIDEOS_DIR = './public/assets/videos/settings_product_service';
const IMAGES_PATH_PREFIX = 'assets/images/settings_product_service';
const VIDEOS_PATH_PREFIX = 'assets/videos/settings_product_service';
...
exports.productServicePage = async (req, res, next) => {
    ...
    res.render('settings/product_service');
};
