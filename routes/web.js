...
const productServiceSettingRoutes = require('./settings/productServiceRoutes');
...
router.use('/product_service', isAuth, productServiceRoutes);
...
router.use('/setting/product_service', isAuth, productServiceSettingRoutes);
